...
def location(request):
    ...
    if request.method == "POST":
        send_mail('La bicycletteBLeue', 'Bonjour, nous vous envoyons cet email pour vous prévenir que votre location se termine dans 10 jours.', settings.EMAIL_HOST_USER, ['daniele.cstr@eduge.ch'], fail_silently=False)
