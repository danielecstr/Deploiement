...
class Local(models.Model):
    ...
    local_nom = models.CharField(max_length=50, db_column='LOCAL_NOM', blank=True, null=True)  # Field name made lowercase.
...
class Velo(models.Model):
    ...
    vel_nom = models.CharField(max_length=100, db_column='VEL_NOM', blank=False, null=True)  # Field name made lowercase.
    vel_marque = models.CharField(max_length=50, db_column='VEL_MARQUE', blank=False, null=True)  # Field name made lowercase.
    vel_couleur = models.CharField(max_length=25, db_column='VEL_COULEUR', blank=False, null=True)  # Field name made lowercase.
    vel_type = models.CharField(max_length=50, db_column='VEL_TYPE', blank=False, null=True)  # Field name made lowercase.
    vel_photo = models.ImageField(upload_to='../accueil/static/img/velo/', blank=True)  # Field name made lowercase.
    vel_statut = models.CharField(max_length=100, db_column='VEL_STATUT', blank=False, null=True)  # Field name made lowercase.
    vel_etat = models.CharField(max_length=100, db_column='VEL_ETAT', blank=False, null=True)  # Field name made lowercase.
